...
export async function oppositeSwapV3Pool(amount : number, isTest : boolean) {

    const inputToken = new Token(new PublicKey(TEST_QUOTE_TOKEN), 9) // test2
    const outputToken = new Token(new PublicKey(TEST_BASE_TOKEN), 9) // test1
